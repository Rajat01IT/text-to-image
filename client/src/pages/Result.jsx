  ...
  return (
    ...
    <div>
      <div className='relative'>
        ...
        <samp className={`absolute bottom-0 left-0 h-1 bg-blue-500 ${loading ? 'w-full transition-all duration-[10s]' : 'w-0'}`}/>
    ...
    {!isImageLoaded &&
    <div className='flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full placeholder:color'>
      <input 
      ...
      <button type='submit' className='bg-zinc-900 px-16 py-3 rounded-full'> Generte</button>
    </div>}
